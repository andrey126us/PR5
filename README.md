...
Выбран **вариант 10: Изменение размеров фигур (кругов, квадратов) на главной странице.**. Пользователь может выбрать один из трёх цветов (красный, зелёный, синий) в экране настроек. После нажатия «Сохранить» фон MainActivity меняется соответственно, а в TextView выводится сообщение о выбранном цвете.
